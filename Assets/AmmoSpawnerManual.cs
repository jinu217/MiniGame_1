...
public class AmmoSpawnerManual : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lastSkillPoint = player.skillPoint;
    ...
    void Update()
    {
        ...
        if (player.skillPoint != lastSkillPoint)
        {
            if (updateRoutine != null)
                StopCoroutine(updateRoutine);
            updateRoutine = StartCoroutine(UpdateAmmoIconsSmooth(player.skillPoint));
            lastSkillPoint = player.skillPoint;
        }
    }
    ...
    {
        int targetCount = Mathf.Max(0, player.skillPoint);
