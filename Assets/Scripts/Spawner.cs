...
//    float safeMinDistX(GameObject a, GameObject b, float margin = 0.01f)
//    {
//        float halfA = GetHalfWidthX(a) * 0.1f; // Bug
//        float halfB = GetHalfWidthX(b); // HeatKit
//        return halfA + halfB + margin;
//    }

//    public void BugSpawn()
//    {
//        Debug.Log(safeMinDistX(bugObject, healKit));
//        //isSpawn = true;
//        int attemptCount = 0;
